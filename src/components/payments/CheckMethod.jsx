...
export default function CheckMethod() {
    return (
        <div className="pt-20 flex flex-col items-start px-5">
            ...
            <h1 className="text-0D text-2xl font-bold mt-7 mb-20">
            ...
            <Link to="/home/orders/payment/information" className='w-full rounded-md border-2 border-solid border-black mt-40 text-black flex items-center justify-center h-12 text-sm tracking-widest font-bold'>ADD CREDIT CARD</Link>
        </div>
    )
}
