    ...
    return (
        <div className='bg-FB flex flex-col items-start gap-5 px-5 pt-20 h-800'>
            ...
            <div className="h-12 w-full flex items-center justify-start pl-2.5 border-2 border-solid border-9F rounded-lg text-9F font-semibold cursor-pointer">
                ...
                <input type="text" className="bg-transparent h-full w-full focus:outline-none" autoComplete="street-address" placeholder="Enter a new address" />
            </div>
            <Link to="/home" className='bg-txt-red w-full rounded-md text-white flex items-center justify-center h-12 text-sm tracking-widest font-bold hover:bg-txt-red/80 duration-300 mt-10'>Finish</Link>
        </div>
    )
}
