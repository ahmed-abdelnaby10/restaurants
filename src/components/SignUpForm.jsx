...
export default function SignUpForm() {
    ...
    return (
        <div className='bg-FB h-screen flex flex-col items-start px-5 pt-5 gap-5'>
            <div>
            ...
            <form onSubmit={(e)=>e.preventDefault()} className='w-full flex flex-col items-start gap-2.5 mb-10'>
                ...
                <Link to="/sign-up/complete-information" className='bg-txt-red w-full rounded-md text-white flex items-center justify-center h-12 text-sm tracking-widest font-bold hover:bg-txt-red/80 duration-300 mt-2.5 mb-1'>SIGN UP</Link>
